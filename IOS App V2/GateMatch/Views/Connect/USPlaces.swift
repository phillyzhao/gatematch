...
enum USPlaces {
    ...
    static let cities: [USCity] = [
        USCity(name: "New York", state: "NY", latitude: 40.7128, longitude: -74.0060),
        USCity(name: "Los Angeles", state: "CA", latitude: 34.0522, longitude: -118.2437),
        USCity(name: "Chicago", state: "IL", latitude: 41.8781, longitude: -87.6298),
        USCity(name: "Houston", state: "TX", latitude: 29.7604, longitude: -95.3698),
        USCity(name: "Phoenix", state: "AZ", latitude: 33.4484, longitude: -112.0740),
        USCity(name: "Philadelphia", state: "PA", latitude: 39.9526, longitude: -75.1652),
        USCity(name: "San Antonio", state: "TX", latitude: 29.4241, longitude: -98.4936),
        USCity(name: "San Diego", state: "CA", latitude: 32.7157, longitude: -117.1611),
        ...
        USCity(name: "Jacksonville", state: "FL", latitude: 30.3322, longitude: -81.6557),
        USCity(name: "San Jose", state: "CA", latitude: 37.3382, longitude: -121.8863),
        USCity(name: "San Francisco", state: "CA", latitude: 37.7749, longitude: -122.4194),
        ...
        USCity(name: "Seattle", state: "WA", latitude: 47.6062, longitude: -122.3321),
        USCity(name: "Denver", state: "CO", latitude: 39.7392, longitude: -104.9903),
        USCity(name: "Washington", state: "DC", latitude: 38.9072, longitude: -77.0369),
        USCity(name: "Boston", state: "MA", latitude: 42.3601, longitude: -71.0589),
        USCity(name: "Nashville", state: "TN", latitude: 36.1627, longitude: -86.7816),
        USCity(name: "Detroit", state: "MI", latitude: 42.3314, longitude: -83.0458),
        USCity(name: "Portland", state: "OR", latitude: 45.5152, longitude: -122.6784),
        USCity(name: "Memphis", state: "TN", latitude: 35.1495, longitude: -90.0490),
        USCity(name: "Las Vegas", state: "NV", latitude: 36.1699, longitude: -115.1398),
        USCity(name: "Louisville", state: "KY", latitude: 38.2527, longitude: -85.7585),
        USCity(name: "Baltimore", state: "MD", latitude: 39.2904, longitude: -76.6122),
        USCity(name: "Milwaukee", state: "WI", latitude: 43.0389, longitude: -87.9065),
        ...
        USCity(name: "Miami", state: "FL", latitude: 25.7617, longitude: -80.1918),
        USCity(name: "Tampa", state: "FL", latitude: 27.9506, longitude: -82.4572),
        ...
        USCity(name: "New Orleans", state: "LA", latitude: 29.9511, longitude: -90.0715),
        USCity(name: "Cleveland", state: "OH", latitude: 41.4993, longitude: -81.6944),
        USCity(name: "Pittsburgh", state: "PA", latitude: 40.4406, longitude: -79.9959),
        USCity(name: "St Louis", state: "MO", latitude: 38.6270, longitude: -90.1994),
        USCity(name: "Cincinnati", state: "OH", latitude: 39.1031, longitude: -84.5120),
        USCity(name: "Salt Lake City", state: "UT", latitude: 40.7608, longitude: -111.8910),
        ...
        USCity(name: "Charleston", state: "SC", latitude: 32.7765, longitude: -79.9311),
        USCity(name: "Honolulu", state: "HI", latitude: 21.3099, longitude: -157.8581),
        USCity(name: "Anchorage", state: "AK", latitude: 61.2181, longitude: -149.9003),
        USCity(name: "Buffalo", state: "NY", latitude: 42.8864, longitude: -78.8784),
        ...
        USCity(name: "Providence", state: "RI", latitude: 41.8240, longitude: -71.4128),
